	...
	<header>
		...
		<div class="menu">
			<ul>
				...
				<li class="menu-item hidden"><a href="<?=base_url() .'/pages/view/about'?>">About Us</a></li>
				<li class="menu-item hidden"><a href="<?=base_url() .'/pages/view/contact'?>">Contact</a>
				</li>
			</ul>
		</div>
